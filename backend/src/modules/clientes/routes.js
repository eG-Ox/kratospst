...
router.get('/consulta-dni/:dni', autorizar('clientes.ver'), controller.consultaDni);
router.get('/consulta-ruc/:ruc', autorizar('clientes.ver'), controller.consultaRuc);
router.get('/consulta_dni/:dni', autorizar('clientes.ver'), controller.consultaDni);
router.get('/consulta_ruc/:ruc', autorizar('clientes.ver'), controller.consultaRuc);
